<template>
  <div class="trade-record">
    <m-header text="收支记录" :showBack="showBack" @back="back"></m-header>
    <div class="container">
      <cube-scroll
        ref="scroll"
        :data="items"
      ...
      >
        ...
        <div class="noData" v-show="items.length === 0 && noData">
          <no-data content="暂无收支记录"></no-data>
        </div>
        <loading></loading>
      </cube-scroll>
    </div>
